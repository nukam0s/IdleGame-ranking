...
**EN**: * **IdleGame** uses **OpenAI gpt-4o-mini** to generate quests, loot, and pets in real-time. Every item is unique and based on your nickname.*

---

## ⚔️ Mecânicas de Poder | Power Mechanics
**PT**: O teu sucesso em duelos e eventos é medido pelo **Poder Total**.
* **Fórmula**: `Base(10) + Nível + Itens Equipados + Bónus do Pet`.
* **Slots**: 🪖 Cabeça, 🛡️ Corpo, 🗡️ Arma, 🥾 Pés e 💍 Acessório.
* **Auto-Equip**: O bot equipa automaticamente o item mais forte.

**EN**: *Your success in duels and events is measured by **Total Power**.*
* ***Formula**: Base(10) + Level + Equipped Items + Pet Bonus.*
* ***Slots**: 🪖 Head, 🛡️ Body, 🗡️ Weapon, 🥾 Feet, and 💍 Accessory.*
* ***Auto-Equip** enabled.*
...
- **Como Reclamar**: Derrota o alvo em `!fight` ou `!duel` dentro de 2h para ganhar o **Triplo do Bounty em XP**!
...
**PT**: Transforma itens fracos em equipamentos superiores.
- `!forge` funde os 2 itens mais fracos da mochila com **30% de chance** de subir raridade.
- `!forge 100` permite a reciclagem em massa de itens abaixo de 100 power.
...
### ⚔️ Duelos & Roubo
**PT**: `!fight <nick>` (3x/dia). Existe **1% de chance** de o vencedor **roubar** um item equipado!
...
**EN**: *`!duel <nick> <xp>` to wager real XP. Winner takes the pot (10% Fee).*
...
**© 2026 IdleGame Project** *Transformando a tua presença numa aventura épica com IA.*
